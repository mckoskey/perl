...
foreach my $filename (@infiles)
{
    ...
    print $file "% \\chapter[" . $util->get_title($filename) . "]{" . $util->get_title($filename) . "}\\label{chap:" . $util->get_label ($filename) . "}\n";
    print $file "\\chapter{" . $util->get_title($filename) . "}\n";
    print $file "\n";
    print $file "\n";
...
{
    print "\n";
    print "\tSyntax: chapter <filename(s)>\n";
    print "\n";
